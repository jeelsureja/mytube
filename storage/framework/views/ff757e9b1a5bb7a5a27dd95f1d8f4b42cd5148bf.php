<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><h1><img src="client_dist/images/logo.png" alt="" /></h1></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
			...
			<div class="header-top-right">
				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									<script type="text/javascript" src="<?php echo e(asset('client_dist/js/modernizr.custom.min.js')); ?>"></script>    
									<link href="<?php echo e(asset('client_dist/css/popuo-box.css')); ?>" rel="stylesheet" type="text/css" media="all" />
									<script src="<?php echo e(asset('client_dist/js/jquery.magnific-popup.js')); ?>" type="text/javascript"></script>
									<!--//pop-up-box -->
    ...
    </nav><?php /**PATH /var/www/html/laravel/Laravel-5.8-Crud-Tutorial-master/resources/views/navbar.blade.php ENDPATH**/ ?>