						...
						<div class="all-comments-info">
							...
							<div class="box">
								...
								@csrf
									...
									<input type="hidden" class="textbox" name="u_id"value="{{ Auth::user()->id }}">
									<input type="text" value="{{ Auth::user()->name}}" disabled><br><br>		           					   
					...
					<div class="single-grid-right">
						...
						<div class="single-right-grids">
							...
							<div class="col-md-4 single-right-grid-left">
								<a href="{{ route('crud.show', $row->id) }}"><img src="{{ URL::to('/') }}/images/{{ $row->image }}" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="{{ route('crud.show', $row->id) }}" class="title"> {{ $row->video_name }}</a>
