					...
					<div class="recommended-grids">
						...
						<div class="col-md-3 resent-grid recommended-grid">
							...
							<div class="resent-grid-img recommended-grid-img">
								<a href="<?php echo e(route('crud.show', $favourite->id)); ?>"><img src="<?php echo e(URL::to('/')); ?>/images/<?php echo e($favourite->image); ?>" alt="" width="200px" height="200px"/></a>
								
							</div>
							<div class="resent-grid-info recommended-grid-info video-info-grid">
								<h5><?php echo e($favourite->video_name); ?></h5>
								
							</div><br>
							<form action="<?php echo e(route('favourites.destroy', $favourite->id)); ?>" method="POST">
								<?php echo csrf_field(); ?>

								<?php echo method_field('DELETE'); ?>
								<button class="btn btn-danger" type="submit" style="margin-left:100px;">Remove</button>
								</form><br>
						</div>
...
</htm><?php /**PATH /var/www/html/projects/mytube/resources/views/favouritevideo.blade.php ENDPATH**/ ?>