					...
					<div class="recommended-grids">
						...
						<div class="col-md-3 resent-grid recommended-grid">
							...
							<form action="<?php echo e(route('video.destroy', $row->id)); ?>" method="POST">
								...
								<button class="btn btn-danger" type="submit" style="margin-left:100px;">Delete</button>
								</form><br>
						</div>
...
</htm><?php /**PATH /var/www/html/projects/mytube/resources/views/videoshow.blade.php ENDPATH**/ ?>