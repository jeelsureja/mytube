...
<form method="post" action="<?php echo e(route('crud.store')); ?>" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label class="col-md-4 text-right">Enter Video Name</label>
    <div class="col-md-8">
  ...
  <br />>
  <div class="form-group">
    <label class="col-md-4 text-right">Enter Video Description</label>
    <div class="col-md-8">
...
</html><?php /**PATH /var/www/html/laravel/Laravel-5.8-Crud-Tutorial-master/resources/views/create.blade.php ENDPATH**/ ?>