                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo e($query); ?><p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo e($query1); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo e($query2); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo e($query3); ?>
...
</html><?php /**PATH /var/www/html/projects/mytube/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>